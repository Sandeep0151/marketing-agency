                        ...
                        <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                            <div className="crp-footer-widget mb-90 tp_fade_anim" data-delay=".3">
                                <div className="crp-footer-logo">
                                    <Link href="#home"><Image width={120} src={logoWhite} alt="logo" /></Link>
                                </div>
                        ...
                        <div className="col-xxl-2 col-xl-3 col-lg-3 col-md-3">
                            <div className="crp-footer-widget mb-90 tp_fade_anim" data-delay=".5">
                                ...
                                <div className="crp-footer-widget-menu">
                                    <ul>
                                        <li><Link className="tp-line-white cream-2" href="#home">Home</Link></li>
                                        <li><Link className="tp-line-white cream-2" href="#about">About Us</Link></li>
                                        <li><Link className="tp-line-white cream-2" href="#services">Services</Link></li>
                                        <li><Link className="tp-line-white cream-2" href="#projects">Our works</Link></li>
                                        <li><Link className="tp-line-white cream-2" href="#blog">Blog Contact</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
